...
class PhoneGapDocs
  ...
  def before_jodoc(input_directory, options)
    #puts "before_jodoc" + input_directory + ", options:"
  ...
  def jodocify(input_directory, options)
    #puts "jodocify" + input_directory + ", options:"
  ...
  def after_jodoc(input_directory, options)
    #puts "after_jodoc" + input_directory + ", options:"
